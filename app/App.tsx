import { SlackwaterProvider } from '@slackwater/react'
import './App.css'
import { TideStation } from '@slackwater/react';
...
function App() {
  ...
  // resolved before mounting the provider — otherwise slackwater fetches with the
